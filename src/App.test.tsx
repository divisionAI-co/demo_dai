...
describe("App", () => {
  ...
  it("no longer renders the previous step 01 description", () => {
    render(<App />);
    expect(
  ...
  it("renders step 01 with its title Intent alongside the new description", () => {
    render(<App />);
    const stepNumber = screen.getByText("01");
    const listItem = stepNumber.closest("li");
    expect(listItem).not.toBeNull();
    expect(listItem).toHaveTextContent("Intent");
    expect(listItem).toHaveTextContent("Add a ticket to your board");
  });
